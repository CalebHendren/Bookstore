...
Book::Book(const std::string& title, const std::string& author, const std::string& genre, const std::string& ISBN,
    ...
    : title(title), author(author), genre(genre), ISBN(ISBN), publicationDate(publicationDate), price(price), quantity(quantity) {}
Book::Book(const Book& other)
    : title(other.title), author(other.author), genre(other.genre), ISBN(other.ISBN), publicationDate(other.publicationDate),
...
public:
    ...
    Order(const std::string& transactionID, const Date& transactionDate, const std::string& customerID, const Book& orderedBook, int quantity)
        : Transaction(transactionID, transactionDate), customerID(customerID), orderedBook(orderedBook), quantity(quantity) {}
...
public:
    // Constructors
    Sale() : Transaction() {}
    Sale(const std::string& transactionID, const Date& transactionDate, const std::string& customerID, const Book& soldBook, int quantity)
